...
3. As a Developer, I want to cover the `ProductService` implementation with unit tests. So that I can safely change the implementation later.
    - All methods of the Service should be tested, independently from their DAO dependencies, using mocking.
